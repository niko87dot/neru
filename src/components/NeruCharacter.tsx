...
const PIXEL = 7  // was 6 — 17% bigger overall
const COLS = 16
const ROWS = 20
...
const BASE: Coord[] = [
  ...
  // Body
  [13, 6], [13, 7], [13, 8], [13, 9],               // neck
  [14, 5], [14, 6], [14, 7], [14, 8], [14, 9], [14, 10], // body
  [15, 5], [15, 6], [15, 7], [15, 8], [15, 9], [15, 10],
  [16, 5], [16, 6], [16, 7], [16, 8], [16, 9], [16, 10],
  [17, 5], [17, 6], [17, 7], [17, 8], [17, 9], [17, 10],
  [14, 3], [14, 4], [15, 3], [15, 4], [16, 4],       // left arm
  [14, 11], [14, 12], [15, 11], [15, 12], [16, 11],  // right arm
]

// ─── Mood eyes — 3×2 solid blocks for neutral/sad clarity ────────────────────
...
const EYES: Record<CharacterMood, Coord[]> = {
  ...
  // Neutral: solid 3×2 blocks — clearly visible, separate eyes
  neutral: [
    [5, 4], [5, 5], [5, 6],
    [6, 4], [6, 5], [6, 6],
    [5, 9], [5, 10], [5, 11],
  ...
  // Sad: droopy 3×2 dashes shifted down (tired look)
  sad: [
    [7, 4], [7, 5], [7, 6],
    [8, 4], [8, 5], [8, 6],
    [7, 9], [7, 10], [7, 11],
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div style={{ position: 'relative', width: W + 40, paddingTop: 20 }}>
        ...
        {/* Pixel character — drop-shadow glow anchored to actual pixels */}
        <div
          style={{
            position: 'relative',
            width: W,
      ...
      {/* Name tag */}
      <div style={{ border: '1px solid #306230', padding: '3px 8px', marginTop: 4 }}>
        <span style={{ fontFamily: '"Press Start 2P"', fontSize: 6, color: '#0f380f', letterSpacing: 2 }}>
          NERU
        </span>
      </div>
    </div>
