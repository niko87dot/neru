...
const EYES: Record<CharacterMood, Coord[]> = {
  // Happy: squinted crescents — single-pixel-tall arcs (^ ^)
  happy: [
    [5, 4], [5, 5], [5, 6],
    [6, 3], [6, 7],
    [5, 9], [5, 10], [5, 11],
...
const MOUTHS: Record<CharacterMood, Coord[]> = {
  // Happy: open smile curve (U shape = big grin)
  happy: [
    [9, 4], [9, 11],
    [10, 5], [10, 10],
    [11, 6], [11, 7], [11, 8], [11, 9],
...
export default function NeruCharacter({ mood }: Props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
      {/* Outer wrapper — room for zzz / sparkles that overflow */}
      ...
      {/* Name tag */}
      <div style={{ border: '1px solid #3d6b1f', padding: '3px 8px', marginTop: 4 }}>
        <span style={{ fontFamily: '"Press Start 2P"', fontSize: 6, color: '#74b83e', letterSpacing: 2 }}>
          NERU
        </span>
      </div>
    </div>
